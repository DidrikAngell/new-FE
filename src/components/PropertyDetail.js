  ...
  return (
    <div className="shadow-md w-full rounded-[10px] p-[20px] space-y-[24px] bg-white">
      <div className="flex items-center justify-between">
        <div className="text-[24px]">Entire villa sold by Sei14zd...0qzk</div>
      ...
      <div className="space-y-[10px]">
        ...
        <div className="flex items-center text-[18px]  gap-[10px]">
          ...
          <div>Grand Sharon Residence</div>
        </div>
        <div className="text-[#959595]">
          Jl. Inspeksi Cidurian, Cileunyi, Bandung, Cileunyi, Bandung, Jawa
          Barat
        </div>
      </div>
      <div className="bg-[#E3E3E3] w-full h-[2px]"></div>
      ...
      <div className="space-y-[10px]">
        <div className="flex items-center gap-[10px]">
          ...
          <div>
            <div className="text-[18px] ">Grand Sharon Residence</div>
            <div className="text-[#959595]">
        ...
        <div className="flex items-center gap-[10px]">
          <img src={Star}></img>
          <div>
            <div className="text-[18px] ">Experienced host</div>
            <div className="text-[#959595]">
        ...
        <div className="flex items-center gap-[10px]">
          <img src={Heart}></img>
          <div>
            <div className="text-[18px] ">Highly rated Host</div>
            <div className="text-[#959595]">
              Bookily has recieved 5-star ratings from 100% of recent guests.
            </div>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        elegant sun terraces with glass balustrade and the modern Desgin make
        the mansion Goyen an exclusive vacation domicile, which fulfills highest
        requirements at cosiness, comfort and situation. 200m² living space,
        400m² garden, sun terrace and roof terrace with floating bed. 3 suites
        all with terrace.
      </div>
      <div className="bg-[#E3E3E3] w-full h-[2px]"></div>
